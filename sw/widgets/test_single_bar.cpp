...
// KY040 encoder_clk = KY040(ENCODER_CLK_GPIO, ENCODER_DT_GPIO, &call_back, encoder_clk_conf);
...
//         break;
//     }
//     EncoderEvent encoder_event = encoder_clk.process_IRQ_event(event_mask);
